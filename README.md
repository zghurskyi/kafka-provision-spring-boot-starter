...
> Note: Introduction article with more details can be found [here](https://www.oxymorus.com/kafka-provision-spring-boot-starter/) and usage example [here](https://github.com/zghurskyi/kafka-provision-examples).
